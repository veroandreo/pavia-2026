...
title-slide-attributes:
  ...
  data-background-image: "../assets/img/lecture_2/qrcode.png"
  data-background-size: "250px"
  data-background-position: "bottom 150px right 150px"
...
1. Do distinct groups of **temporal activity patterns** exist among *Ae. aegypti* ovitrap data?
2. Are those patterns **associated with local environmental conditions** detectable from satellite imagery?
3. Can we **predict patterns city-wide** where no mosquito field data exist?
...
All covariates were extracted over **buffer areas** of 50 and 100m radius around each ovitrap location (flight range of female mosquitoes).
...
[Routines: <https://github.com/veroandreo/mosquito-ts-clust>]{.tiny}
...
- Correlate with dengue incidence (cases / 10,000 inhabitants) per neighbourhood
...
- **Weak but positive** association between proportion of group 3 pixels and neighbourhood-level dengue incidence (ρ ≈ 0.15, p < 0.05)
...
- **2017–2018**: diversity measures and average vegetation/water conditions more relevant — but accuracy was lower
...
3. The spatial distribution of patterns might have **epidemiological relevance** (dengue)
4. Open-source tools (GRASS, Python, R) make this workflow **reproducible**
:::

## Implications for public health

Understanding *where* and *when* mosquitoes are most active — 
without exhaustive field campaigns — could:
...
![](../assets/img/lecture_2/qrcode.png){fig-align="center" width="200px"}
