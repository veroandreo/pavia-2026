...
::: {.callout-note}
Open the HTML report in `model_02/` to inspect the mean test AUC across folds, variable importance (% contribution and permutation importance), and response curves.
:::
...
sdm_cv_map = gj.InteractiveMap(width=500, use_region=True)
